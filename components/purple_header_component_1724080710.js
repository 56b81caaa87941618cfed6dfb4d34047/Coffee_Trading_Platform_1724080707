...
Vue.component("purple_header_component_1724080710", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Shop-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Shop.html">Shop</a></li>
                        <li><a id="About Us-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="About Us.html">About Us</a></li>
                        <li><a id="Brew Guides-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Brew Guides.html">Brew Guides</a></li>
                        <li><a id="Contact-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-pink-200 hover:text-white" href="Contact.html">Contact</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 bg-opacity-30 bg-purple-900 backdrop-filter backdrop-blur-lg shadow-lg">
                            <li><a id="mobile-Home-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Home.html">Home</a></li>
                            <li><a id="mobile-Shop-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Shop.html">Shop</a></li>
                            <li><a id="mobile-About Us-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="About Us.html">About Us</a></li>
                            <li><a id="mobile-Brew Guides-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Brew Guides.html">Brew Guides</a></li>
                            <li><a id="mobile-Contact-link" class="flex font-medium text-sm py-1.5 text-pink-200 hover:text-white" href="Contact.html">Contact</a></li>
                        </ul>
                    </nav>
